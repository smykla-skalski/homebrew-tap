...
# GitHubPrivateRepositoryReleaseDownloadStrategy downloads release assets from GitHub
# Private Repository. To use it, add `using: GitHubPrivateRepositoryReleaseDownloadStrategy`
